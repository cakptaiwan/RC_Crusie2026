...
export const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/royalcruiserasia/',
    icon: 'ig',
    svg: `<svg class="h-full w-full" viewBox="0 0 24 24" aria-hidden="true"><path fill="#E1306C" d="${IG_PATH}"/></svg>`,
    navSvg: navIcon(IG_PATH),
  },
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/61591129253765',
    icon: 'fb',
    svg: `<svg class="h-full w-full" viewBox="0 0 24 24" aria-hidden="true"><path fill="#1877F2" d="${FB_PATH}"/></svg>`,
    navSvg: navIcon(FB_PATH),
  },
] as const;
